...
import {
  ...
  SmallBusinessHomepageDesignArticle,
...
export const resources: readonly ResourceArticle[] = [
  ...
  {
    slug: "what-is-information-architecture-in-web-design",
    title: "What Is Information Architecture in Web Design?",
    seoTitle: "What Is Information Architecture in Web Design?",
    shortTitle: "Information architecture in web design",
    description:
      "Learn how page relationships, navigation, hierarchy, and content grouping shape a small-business website before visual design begins.",
    topic: "Web Design",
    category: "Website fundamentals",
    funnel: "Educational",
    primaryTarget: "what is information architecture in web design",
    secondaryTargets: [
      "website information architecture",
      "information architecture for small business websites",
      "website structure and navigation",
      "how to organize website content",
    ],
    intent:
      "Understand and plan a small-business website structure before visual design.",
    nextStep: "/resources/how-to-design-a-small-business-homepage",
    publishedAt: "2026-08-30",
    tableOfContents: [
      { id: "meaning", label: "What information architecture means" },
      { id: "layers", label: "Sitemap, navigation, and layout" },
      { id: "service-structure", label: "Organizing services" },
      { id: "example", label: "A local business example" },
      { id: "outcomes", label: "Conversion and search" },
      { id: "planning", label: "Planning the structure" },
    ],
    relatedSlugs: [
      "how-to-design-a-small-business-homepage",
      "what-should-a-local-business-website-include",
      "website-redesign-vs-rebuild",
    ],
    Content: InformationArchitectureWebDesignArticle,
  },
  {
    slug: "how-to-design-a-small-business-homepage",
    title: "How to Design a Small Business Homepage",
    seoTitle: "How to Design a Small Business Homepage",
    shortTitle: "Designing a small-business homepage",
    description:
      "Plan a small-business homepage that explains the offer, establishes trust, and gives visitors a clear next step without cramming in the entire site.",
    topic: "Web Design",
    category: "Website fundamentals",
    funnel: "Educational",
    primaryTarget: "how to design a small business homepage",
    secondaryTargets: [
      "small business homepage design",
      "what should a business homepage include",
      "small business homepage layout",
      "homepage content for small business",
    ],
    intent:
      "Plan small-business homepage content, hierarchy, and actions before visual styling.",
    nextStep: "/resources/what-should-a-local-business-website-include",
    publishedAt: "2026-08-30",
    tableOfContents: [
      { id: "job", label: "What the homepage must do" },
      { id: "first-screen", label: "The first screen" },
      { id: "hierarchy-navigation", label: "Hierarchy and navigation" },
      { id: "sections", label: "Choosing homepage sections" },
      { id: "length", label: "Length and clutter" },
      { id: "mobile-review", label: "The mobile sequence" },
    ],
    relatedSlugs: [
    ...
    Content: SmallBusinessHomepageDesignArticle,
  },
  {
