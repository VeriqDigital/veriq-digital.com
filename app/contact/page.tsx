...
export const metadata = createPageMetadata({
  ...
  description:
    "Contact Veriq about custom website design and development, website redesigns, local SEO, conversion tools, or ongoing website support in Des Moines and Central Iowa.",
  path: "/contact",
});
