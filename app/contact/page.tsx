...
export const metadata = createPageMetadata({
  ...
  description:
    "Contact Veriq Digital about web design, website redesigns, local SEO, conversion-focused website tools, or ongoing website support in Des Moines and Central Iowa.",
  path: "/contact",
});
