...
export default function WebsiteNotOnGoogleArticle() {
  return (
    <>
      <ArticleSection id="indexed" title="First, check whether Google knows the page exists">
        <p>
        ...
        <p>
          ...
          Search Console, where URL Inspection can report whether a specific URL
          is indexed and whether Google encountered a crawl or indexing issue.
        </p>
        <ArticleCallout title="Indexing is not ranking">
          <p>
            Submitting a sitemap or requesting indexing can help Google discover
            a page. It does not guarantee that the page will appear for a
            competitive search. Relevance, quality, local signals, authority,
            and time still matter.
          </p>
        </ArticleCallout>
      </ArticleSection>

      <ArticleSection id="crawlability" title="Make sure search engines can reach and understand the site">
        <p>
          Technical settings can unintentionally keep a site out of search. A
          developer or SEO review should check for noindex directives, blocked
          paths in robots.txt, incorrect canonical URLs, redirect loops, broken
          internal links, server errors, and pages that only reveal important
          content after a browser-side interaction.
        </p>
        <p>
      ...
      <ArticleSection id="relevance" title="Show clear service and local relevance">
        <p>
      ...
      <ArticleSection id="authority" title="Competition and authority affect visibility">
        <p>
          ...
          prominence, better content, or more credible websites linking to
          them. Competitive queries take sustained work, not a hidden metadata
          field.
        </p>
        <p>
      ...
      <ArticleSection id="next-steps" title="A sensible order of operations">
        <ol>
          <li>Verify the preferred domain and important URLs in Search Console.</li>
          <li>Confirm that the pages are crawlable, indexable, canonical, and included in the sitemap.</li>
          <li>Fix server errors, broken links, redirect problems, and missing page fundamentals.</li>
          <li>Improve the pages that best match real customer searches and business priorities.</li>
          <li>Align the Google Business Profile and other major listings with current information.</li>
          <li>Measure impressions, clicks, inquiries, calls, and bookings over time.</li>
        </ol>
        <p>
        ...
        <ArticleCallout title="Strengthen the foundation first">
          <p>
            ...
            <Link href="/des-moines-web-design">Des Moines web design work</Link>.
          </p>
        </ArticleCallout>
      </ArticleSection>
    </>
